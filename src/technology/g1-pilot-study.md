...
Third, the occurrence of a few extreme values generated by the G1 OPQBoxes calls into question their data processing capabilities.  We need to determine ways to better validate the accuracy and reliability of OPQBoxes in future generations of the hardware. 
...
Schematics and other documentation for the G1 OPQBox can be found in the [OPQBox Gen1 repository](https://github.com/openpowerquality/opq-hardware/tree/master/Gen1). 
